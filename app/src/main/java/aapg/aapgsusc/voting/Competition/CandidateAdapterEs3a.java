...
public class CandidateAdapterEs3a extends ArrayAdapter<Candidate> {
    public CandidateAdapterEs3a(Activity context, List<Candidate> candidates) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (listItemView == null) {
            listItemView = LayoutInflater.from(getContext()).inflate(
                    R.layout.list_item_es3a, parent, false);
        }
